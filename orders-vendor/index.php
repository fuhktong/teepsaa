...
<?php
$headTitle = ($tab === 'refunds' ? 'Refunds' : 'Orders') . ' — teepsaa';
$headCss   = ['/products/products.css', '/analytics/analytics.css', '/order-status/order-status.css', '/refund-status/refund-status.css'];
$headSeo   = false;
