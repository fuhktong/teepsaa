...
try {
    $page = $pdo->query("SELECT * FROM content_pages WHERE slug = 'privacy'")->fetch();
...
$t = seo_t();
$seoTitle = $page ? pick_lang($page['title_en'], $page['title_km']) : $t['footer_privacy'];

$headTitle = $seoTitle . ' — teepsaa';
$headDesc  = $t['seo_desc_privacy'];
$headUrl   = 'https://teepsaa.com/privacy/';
$headCss   = ['/privacy/privacy.css'];
