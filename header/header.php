    ...
    <div class="mobile-nav" id="mobile-nav">
        <?php if ($isAdminHeader || (isset($_SESSION['user_id']) && isset($_SESSION['role']))): ?>
            <?php if ($isAdminHeader): ?>
                ...
                <?php if (admin_can('vendors')): ?><a href="/admin/vendors.php" class="mobile-nav-link <?= ($adminSection ?? '') === 'vendors' ? 'active' : '' ?>"><?= ($adminNavAdmin ?? 0) > 0 ? 'Vendors (' . $adminNavAdmin . ')' : 'Vendors' ?></a><?php endif; ?>
