...
// forgot-password-buyer/request.php, and the one auth flow the app does not
// finish itself.
//
// The link in the email opens reset-password-buyer/ in the phone's browser,
// where the new password is set; the buyer then comes back to the app and signs
