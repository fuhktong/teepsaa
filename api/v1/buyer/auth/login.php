<?php
// Buyer login for the buyer app — the twin of api/v1/auth/login.php, against
// the buyers table. The checks below are the same ones
// login-buyer/login-buyer.php performs, in the same order, because this is a
...
// Free text the buyer sees later on a "signed-in devices" list. Never matched
...
// The website sends an unverified buyer to /resend-verification/. The app has
