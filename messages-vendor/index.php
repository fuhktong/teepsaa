...
<main>
    <div class="msg-header">
        ...
        <?php if ($pendingThread): ?>
            <a href="/messages-vendor/thread.php?id=<?= $pendingThread['id'] ?>" class="msg-contact-btn">View pending request</a>
        <?php else: ?>
            <a href="/contact-vendor/" class="msg-contact-btn">Contact Support</a>
        <?php endif; ?>
    </div>
