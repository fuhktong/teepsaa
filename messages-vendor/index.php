...
<?php
$headTitle = 'Support Messages — teepsaa';
$headCss   = ['/messages-vendor/messages-vendor.css'];
$headSeo   = false;
...
<main>
    ...
    <div class="thread-list">
        ...
        <a href="/messages-vendor/thread.php?id=<?= $th['id'] ?>" class="thread-row <?= $th['unread_count'] > 0 ? 'thread-row--unread' : '' ?>">
