...
<main <?= !$isPending ? 'class="chat-main"' : '' ?>>
    ...
    <a href="/messages-vendor/" class="ticket-back">← Support</a>
    ...
    <?php else: ?>
    <div class="chat-closed-bar">This conversation is closed. If you need further help, <a href="/contact-vendor/">contact support</a>.</div>
    <?php endif; ?>
