...
## Functional testing — verified flows (archived 2026-08-23 from teepsaa-todos-functional-testing.md)

All run against the LIVE Hostinger site, not local MAMP. 96 of 101 checks
passed; the remainder — plus seven of these that admit unfinished work in
