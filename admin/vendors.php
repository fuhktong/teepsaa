...
<main>
    ...
    <div class="admin-filters-row">
        <form method="GET" action="/admin/vendors.php" class="admin-search-form">
        ...
        <div class="order-filters">
            ...
            <a href="/admin/vendors.php?status=<?= $key ?><?= $vSearchQ . $vCatQ ?>" class="filter-btn <?= $statusFilter === $key ? 'active' : '' ?>">
