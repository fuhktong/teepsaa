...
<?php
$headTitle = 'Contact Support — teepsaa';
$headCss   = ['/contact-buyer/contact-buyer.css'];
$headSeo   = false;
...
<main>
    ...
    <?php if ($hasPending): ?>
        ...
        <p><a href="/messages-buyer/"><?= $t['contact_view_messages'] ?></a></p>
    <?php else: ?>
    ...
    <form method="POST" action="/contact-buyer/submit.php" class="contact-form">
        ...
        <div class="contact-field">
            ...
            <select id="issue_type" name="issue_type" required>
                ...
                <?php foreach (['Order issue' => $t['contact_issue_order'], 'Payment issue' => $t['contact_issue_payment'], 'Account issue' => $t['contact_issue_account'], 'Other' => $t['contact_issue_other']] as $val => $lbl): ?>
        ...
        <div class="contact-actions">
            ...
            <a href="/messages-buyer/" class="contact-btn contact-btn--secondary"><?= $t['btn_cancel'] ?></a>
        </div>
    </form>
    <?php endif; ?>
</main>
