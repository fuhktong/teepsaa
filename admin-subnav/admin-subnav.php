<?php
// Admin panel subnav — the main section tabs (Orders, Admin, Marketing,
// Content, Messages), shown under the header on every admin page, ordered
// most-worked first. Each section's pages are the second-level tabs in
// admin/admin-tabs.php. The header <nav> keeps only the avatar and lang
// menus. Include right after header/header.php; the header already computes
// the roll-up badge counts and active section for its mobile nav, so reuse
// them when set. There is no page at /admin/ itself — the logo and bare
// admin URL land on the first section the admin can open (admin_home_url()).
